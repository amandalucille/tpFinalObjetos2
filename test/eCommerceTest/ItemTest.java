...
public class ItemTest extends SetUp {
   ...
   public void testDeValidezDeProducto() {
       ItemInvalidoException exSinSKU = assertThrows(ItemInvalidoException.class, () -> new Producto(null, "Remera", "Remera de algodón", "Nike", "Ropa", 500.0, 2, 9.0));
       assertEquals("El ítem 'Remera' es inválido: El SKU no puede ser nulo o vacío.", exSinSKU.getMessage());
       
       ItemInvalidoException exSKUIsBlank = assertThrows(ItemInvalidoException.class, () ->  new Producto("  ", "Remera", "Remera de algodón", "Nike", "Ropa", 500.0, 2, 9.0));
       assertEquals("El ítem 'Remera' es inválido: El SKU no puede ser nulo o vacío.", exSKUIsBlank.getMessage());
       
       ItemInvalidoException exSinNombre = assertThrows(ItemInvalidoException.class, () -> new Producto("1", null, "Remera de algodón", "Nike", "Ropa", 500.0, 3, 10.0));
       ...
       ItemInvalidoException exNombreIsBlank = assertThrows(ItemInvalidoException.class, () -> new Producto("1", "  ", "Remera de algodón", "Nike", "Ropa", 500.0, 3, 10.0));
       ...
       ItemInvalidoException exSinDescripcion = assertThrows(ItemInvalidoException.class, () -> new Producto("2", "Remera", null, "Nike", "Ropa", 500.0, 4, 16.0));
       assertEquals("El ítem 'Remera' es inválido: La descripción del producto es obligatoria.", exSinDescripcion.getMessage());
       
       ItemInvalidoException exDescripcionIsBlank = assertThrows(ItemInvalidoException.class, () -> new Producto("2", "Remera", "  ", "Nike", "Ropa", 500.0, 4, 16.0));
       assertEquals("El ítem 'Remera' es inválido: La descripción del producto es obligatoria.", exDescripcionIsBlank.getMessage());
       
       ItemInvalidoException exSinMarca = assertThrows(ItemInvalidoException.class, () -> new Producto("3", "Remera", "Remera de algodón", null, "Ropa", 500.0, 5, 2.4));
       assertEquals("El ítem 'Remera' es inválido: La marca del producto es obligatoria.", exSinMarca.getMessage());
       
       ItemInvalidoException exMarcaIsBlank = assertThrows(ItemInvalidoException.class, () -> new Producto("3", "Remera", "Remera de algodón", "  ", "Ropa", 500.0, 5, 2.4));
       assertEquals("El ítem 'Remera' es inválido: La marca del producto es obligatoria.", exMarcaIsBlank.getMessage());
       
       ItemInvalidoException exSinCategoria = assertThrows(ItemInvalidoException.class, () -> new Producto("4", "Remera", "Remera de algodón", "Nike", null, 500.0, 6, 12.4));
       assertEquals("El ítem 'Remera' es inválido: La categoría del producto es obligatoria.", exSinCategoria.getMessage());
       
       ItemInvalidoException exCategoriaIsBlank = assertThrows(ItemInvalidoException.class, () -> new Producto("4", "Remera", "Remera de algodón", "Nike", "  ", 500.0, 6, 12.4));
       assertEquals("El ítem 'Remera' es inválido: La categoría del producto es obligatoria.", exCategoriaIsBlank.getMessage());
       
       ItemInvalidoException exPrecioNegativo = assertThrows(ItemInvalidoException.class, () -> new Producto("5", "Remera", "Remera de algodón", "Nike", "Ropa", -10.0, 7, 5.76));
       assertEquals("El ítem 'Remera' es inválido: El precio debe ser un valor mayor a 0.", exPrecioNegativo.getMessage());
       
       ItemInvalidoException exPrecioNull = assertThrows(ItemInvalidoException.class, () -> new Producto("5", "Remera", "Remera de algodón", "Nike", "Ropa", null, 7, 5.76));
       assertEquals("El ítem 'Remera' es inválido: El precio debe ser un valor mayor a 0.", exPrecioNull.getMessage());
       
       ItemInvalidoException exStockNegativo = assertThrows(ItemInvalidoException.class, () -> new Producto("5", "Remera", "Remera de algodón", "Nike", "Ropa", 10.0, -3, 10.5));
       assertEquals("El ítem 'Remera' es inválido: El stock no puede ser nulo ni tener un valor negativo.", exStockNegativo.getMessage());
       
       ItemInvalidoException exStockNull = assertThrows(ItemInvalidoException.class, () -> new Producto("5", "Remera", "Remera de algodón", "Nike", "Ropa", 10.0, null, 10.5));
       assertEquals("El ítem 'Remera' es inválido: El stock no puede ser nulo ni tener un valor negativo.", exStockNull.getMessage());
       
       ItemInvalidoException exPesoNegativo = assertThrows(ItemInvalidoException.class, () ->  new Producto("5", "Remera", "Remera de algodón", "Nike", "Ropa", 10.0, 7, -10.5));
       assertEquals("El ítem 'Remera' es inválido: El peso del producto debe ser un valor mayor a 0.", exPesoNegativo.getMessage());
       
       ItemInvalidoException exPesoNull = assertThrows(ItemInvalidoException.class, () -> new Producto("5", "Remera", "Remera de algodón", "Nike", "Ropa", 10.0, 7, null));
   ...
   public void testValidezDePaquete() {
       ItemInvalidoException exSinNombre = assertThrows(ItemInvalidoException.class, () -> new Paquete(null, "Paquete pruebas", "Categoría", 9)
       );
       ...
       ItemInvalidoException exNombreIsBlank = assertThrows(ItemInvalidoException.class, () ->  new Paquete("  ", "Paquete pruebas", "Categoría", 9)
       );
       ...
       ItemInvalidoException exSinDescripcion = assertThrows(ItemInvalidoException.class, () -> new Paquete("Combo", null, "Categoría", 9)
       );
       assertEquals("El ítem 'Combo' es inválido: La descripción del paquete es obligatoria.", exSinDescripcion.getMessage());
       
       ItemInvalidoException exDescripcionIsBlank = assertThrows(ItemInvalidoException.class, () -> new Paquete("Combo", "   ", "Categoría", 9)
       );
       assertEquals("El ítem 'Combo' es inválido: La descripción del paquete es obligatoria.", exDescripcionIsBlank.getMessage());
       
       ItemInvalidoException exSinCategoria = assertThrows(ItemInvalidoException.class, () ->  new Paquete("Combo", "Descripción", null, 9)
       );
       assertEquals("El ítem 'Combo' es inválido: La categoría del paquete es obligatoria.", exSinCategoria.getMessage());
       
       ItemInvalidoException exCategoriaVacia = assertThrows(ItemInvalidoException.class, () -> new Paquete("Combo", "Descripción", "   ", 9)
       );
       assertEquals("El ítem 'Combo' es inválido: La categoría del paquete es obligatoria.", exCategoriaVacia.getMessage());
       
       ItemInvalidoException exSinStock = assertThrows(ItemInvalidoException.class, () -> new Paquete("Combo", "Descripción", "Categoría", null)
       );
       assertEquals("El ítem 'Combo' es inválido: El stock no puede ser nulo ni tener un valor negativo.", exSinStock.getMessage());
       
       ItemInvalidoException exStockNegativo = assertThrows(ItemInvalidoException.class, () -> new Paquete("Combo", "Descripción", "Categoría", -5)
       );
   ...
   public void testDecrementarStockInvalido() {
       StockInsuficienteException exSinStockProducto = assertThrows(StockInsuficienteException.class, () -> productoSinStock.decrementarStock(4));
       assertEquals("No hay stock suficiente de Notebook, quedan 0", exSinStockProducto.getMessage());

       StockInsuficienteException exSinStockPaquete = assertThrows(StockInsuficienteException.class, () -> paqueteSinStock.decrementarStock(3));
